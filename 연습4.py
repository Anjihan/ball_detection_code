#예제 10.11 cv2.meanShift + cv2.KalmanFilter 물체 추적
import cv2
import numpy as np
...
term_crit = (cv2.TERM_CRITERIA_MAX_ITER + cv2.TERM_CRITERIA_EPS,
              10, 1)
...
#4-3: meanShift tracking
    ...
    ret, track_window = cv2.meanShift(backP, track_window,
                                      term_crit)
    x, y, w, h = track_window
